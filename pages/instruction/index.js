  ...
  return (
    <section className={classes.Instruction}>
      ...
      <div className={classes.Container}>
        ...
        <ul>
          <li>
            Total duration of JEE-Main - 40503618_BTECH 8th Jan 2020 Shift 1 is
            180 min.
          </li>
          <li>
          ...
          <li>
            ...
            Palette at the right of your screen to go to that numbered question
            directly. Note that using this option does NOT save your answer to
